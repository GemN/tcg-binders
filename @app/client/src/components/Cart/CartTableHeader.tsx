...
export const CartTableHeader = ({
  ...
  return (
    <div className="hidden h-12 items-center gap-3 rounded-md border border-border bg-card px-3 text-xs font-semibold uppercase text-muted-foreground lg:grid lg:grid-cols-[2rem_minmax(0,1fr)_8rem_9rem_8rem_5rem] lg:gap-x-3 lg:px-8">
      <Checkbox
